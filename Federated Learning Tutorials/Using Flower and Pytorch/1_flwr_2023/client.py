...
# In simulation, we don't want to send FlowerClient class to generate class each time when server wants to spawn a client in each round
# Instead we want to pass a fun that can be called by a server in order to spawn the clients. 
